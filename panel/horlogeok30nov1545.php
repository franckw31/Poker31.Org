...
if ($_SESSION["stop"] == '0') { ?> 
    ...
    <script type="text/javascript">
        ...
        function compteur() { if (!nIntervId) { nIntervId = setInterval(decompte, 100);}}
        ...
        function compteur2() { if (!nIntervId) { nIntervId = setInterval(decompte2, 100); }}
        ...
        function compteur3() { if (!nIntervId) { nIntervId = setInterval(decompte3, 100); }}
        ...
        function compteur4() { if (!nIntervId) { nIntervId = setInterval(decompte4, 100); }}
        ...
        function compteur5() { if (!nIntervId) { nIntervId = setInterval(decompte5, 100); }}
        ...
        function compteur6() { if (!nIntervId) { nIntervId = setInterval(decompte6, 100); }}
        ...
        function compteur7() { if (!nIntervId) { nIntervId = setInterval(decompte7, 100); }}
        ...
        function compteur8() { if (!nIntervId) { nIntervId = setInterval(decompte8, 100); }}
        ...
        function compteur9() { if (!nIntervId) { nIntervId = setInterval(decompte9, 100); }}
        ...
        function compteur10() { if (!nIntervId) { nIntervId = setInterval(decompte10, 100); }}
        ...
        function compteur11() { if (!nIntervId) { nIntervId = setInterval(decompte11, 100); }}
        ...
        function compteur12() { if (!nIntervId) { nIntervId = setInterval(decompte12, 100); }}
        ...
        function compteur13() { if (!nIntervId) { nIntervId = setInterval(decompte13, 100); }}
        ...
        function compteur14() { if (!nIntervId) { nIntervId = setInterval(decompte14, 100); }}
        ...
        function compteur15() { if (!nIntervId) { nIntervId = setInterval(decompte15, 100); }}
        ...
        function compteur16() { if (!nIntervId) { nIntervId = setInterval(decompte16, 100); }}
        function decompte16() { var xmlhttp=new XMLHttpRequest(); xmlhttp.open("GET","response.php",false); xmlhttp.send(null);                     
            if (xmlhttp.responseText == 0) {stopcompteur6();compteur17()} else {document.getElementById("response").innerHTML=document.getElementById("nom16").value+" + "+document.getElementById("ante16").value+" : "+xmlhttp.responseText;}}
        function stopcompteur16() { clearInterval(nIntervId); nIntervId = null; }

        function compteur17() { if (!nIntervId) { nIntervId = setInterval(decompte17, 100); }}
        ...
        function compteur18() { if (!nIntervId) { nIntervId = setInterval(decompte18, 100); }}
        ...
        function compteur19() { if (!nIntervId) { nIntervId = setInterval(decompte19, 100); }}
        ...
        function compteur20() { if (!nIntervId) { nIntervId = setInterval(decompte20, 100); }}
        ...
        function compteur21() { if (!nIntervId) { nIntervId = setInterval(decompte21, 100); }}
        ...
        function compteur22() { if (!nIntervId) { nIntervId = setInterval(decompte22, 100); }}
        ...
        function compteur23() { if (!nIntervId) { nIntervId = setInterval(decompte23, 100); }}
        ...
        function compteur24() { if (!nIntervId) { nIntervId = setInterval(decompte24, 100); }}
        ...
        function compteur25() { if (!nIntervId) { nIntervId = setInterval(decompte25, 100); }}
        function decompte25() { var xmlhttp=new XMLHttpRequest(); xmlhttp.open("GET","response.php",false); xmlhttp.send(null);                     
            if (xmlhttp.responseText == 0) {stopcompteur25();compteur26()} else {document.getElementById("response").innerHTML=document.getElementById("nom25").value+" + "+document.getElementById("ante25").value+" : "+xmlhttp.responseText;}}
